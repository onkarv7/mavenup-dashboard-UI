          ...
          <Box className="interview-box">
            ...
            <div>
              ...
              <div className="lorem1">
                {" "}
                <div className="t1"> Lorem ipsum dolor sit amet</div>
                <div className="d3 date-font">6th April, 2022</div>
              </div>
              <div className="lorem2">
                {" "}
                <div className="t2"> Lorem ipsum dolor sit amet</div>
                <div className="d4 date-font">6th April, 2022</div>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="wireframing-div1">
                ...
                <div className="t5">
                  <img
                    className="Wireframming"
                    src="Wireframming.svg"
                    alt="Wireframming"
                  />
                  Wireframing
                  <img
                    className="Wireframming2"
                    src="Wireframming2.svg"
                    alt="Wireframming2"
                  />
                  <img
                    className="Wireframming4"
                    src="Wireframming4.svg"
                    alt="Wirframming4"
                  />
                  <img
                    className="Wireframming3"
                    src="Wireframming3.svg"
                    alt="Wireframming3"
                  />
                </div>
              </div>
